...
public class MiniBoss extends Enemy {
	...
	public MiniBoss(Game env, int hp, int x, int y, int ap, int ar) {
		super(hp, x, y, ap, ar, Types.MINI_BOSS);
		setEnv(env);
	...
	public void die() {
		this.getEnv().getCurrentMap().getObjects().add(new Fragment((int)Math.round(this.getX()), (int)Math.round(this.getY()), this));
